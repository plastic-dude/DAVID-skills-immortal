...
## When to Use
- When coalition building is required at evaluation level
- When complexity demands evaluation approach to coalition building
- When standard methods fail and evaluation is needed

## How to Apply
1. **Assess**: Evaluate the situation for coalition building requirements
2. **Prepare**: Gather resources and knowledge for evaluation coalition building
3. **Execute**: Apply evaluation techniques for coalition building
...
- Seek feedback on evaluation coalition building approach
...
- Coalition Building — Offense — alternate variation
...
---
Skill ID: the-heart-coalition-building-evaluation
Branch: the-heart
