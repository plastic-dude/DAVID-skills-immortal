...
## When to Use
- When coalition building is required at deep level
- When complexity demands deep approach to coalition building
- When standard methods fail and deep is needed

## How to Apply
1. **Assess**: Evaluate the situation for coalition building requirements
2. **Prepare**: Gather resources and knowledge for deep coalition building
3. **Execute**: Apply deep techniques for coalition building
...
- Seek feedback on deep coalition building approach
...
- Coalition Building — Application — alternate variation
...
---
Skill ID: the-heart-coalition-building-deep
Branch: the-heart
