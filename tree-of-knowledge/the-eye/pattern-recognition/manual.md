...
## When to Use
- When pattern recognition is required at manual level
- When complexity demands manual approach to pattern recognition
- When standard methods fail and manual is needed

## How to Apply
1. **Assess**: Evaluate the situation for pattern recognition requirements
2. **Prepare**: Gather resources and knowledge for manual pattern recognition
3. **Execute**: Apply manual techniques for pattern recognition
...
- Seek feedback on manual pattern recognition approach
...
- Pattern Recognition — Offense — alternate variation
...
---
Skill ID: the-eye-pattern-recognition-manual
Branch: the-eye
