...
## When to Use
- When intent reading is required at offense level
- When complexity demands offense approach to intent reading
- When standard methods fail and offense is needed

## How to Apply
1. **Assess**: Evaluate the situation for intent reading requirements
2. **Prepare**: Gather resources and knowledge for offense intent reading
3. **Execute**: Apply offense techniques for intent reading
...
- Seek feedback on offense intent reading approach
...
- Intent Reading — Recovery — alternate variation
...
---
Skill ID: the-eye-intent-reading-offense
Branch: the-eye
