...
## When to Use
- When intent reading is required at recovery level
- When complexity demands recovery approach to intent reading
- When standard methods fail and recovery is needed

## How to Apply
1. **Assess**: Evaluate the situation for intent reading requirements
2. **Prepare**: Gather resources and knowledge for recovery intent reading
3. **Execute**: Apply recovery techniques for intent reading
...
- Seek feedback on recovery intent reading approach
...
- Intent Reading — Offense — alternate variation
...
---
Skill ID: the-eye-intent-reading-recovery
Branch: the-eye
