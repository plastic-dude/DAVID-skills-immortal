...
## When to Use
- When intent reading is required at deep level
- When complexity demands deep approach to intent reading
- When standard methods fail and deep is needed

## How to Apply
1. **Assess**: Evaluate the situation for intent reading requirements
2. **Prepare**: Gather resources and knowledge for deep intent reading
3. **Execute**: Apply deep techniques for intent reading
...
- Seek feedback on deep intent reading approach
...
- Intent Reading — Automated — alternate variation
...
---
Skill ID: the-eye-intent-reading-deep
Branch: the-eye
