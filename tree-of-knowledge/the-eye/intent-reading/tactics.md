...
## When to Use
- When intent reading is required at tactics level
- When complexity demands tactics approach to intent reading
- When standard methods fail and tactics is needed

## How to Apply
1. **Assess**: Evaluate the situation for intent reading requirements
2. **Prepare**: Gather resources and knowledge for tactics intent reading
3. **Execute**: Apply tactics techniques for intent reading
...
- Seek feedback on tactics intent reading approach
...
- Intent Reading — Counter — alternate variation
...
---
Skill ID: the-eye-intent-reading-tactics
Branch: the-eye
