...
## When to Use
- When intent reading is required at journeyman level
- When complexity demands journeyman approach to intent reading
- When standard methods fail and journeyman is needed

## How to Apply
1. **Assess**: Evaluate the situation for intent reading requirements
2. **Prepare**: Gather resources and knowledge for journeyman intent reading
3. **Execute**: Apply journeyman techniques for intent reading
...
- Seek feedback on journeyman intent reading approach
...
---
Skill ID: the-eye-intent-reading-journeyman
Branch: the-eye
