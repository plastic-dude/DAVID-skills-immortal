...
## When to Use
- When intent reading is required at strategy level
- When complexity demands strategy approach to intent reading
- When standard methods fail and strategy is needed

## How to Apply
1. **Assess**: Evaluate the situation for intent reading requirements
2. **Prepare**: Gather resources and knowledge for strategy intent reading
3. **Execute**: Apply strategy techniques for intent reading
...
- Seek feedback on strategy intent reading approach
...
---
Skill ID: the-eye-intent-reading-strategy
Branch: the-eye
