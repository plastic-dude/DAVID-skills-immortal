...
## When to Use
- When intent reading is required at advanced level
- When complexity demands advanced approach to intent reading
- When standard methods fail and advanced is needed

## How to Apply
1. **Assess**: Evaluate the situation for intent reading requirements
2. **Prepare**: Gather resources and knowledge for advanced intent reading
3. **Execute**: Apply advanced techniques for intent reading
...
- Seek feedback on advanced intent reading approach
...
---
Skill ID: the-eye-intent-reading-advanced
Branch: the-eye
