...
## When to Use
- When automation crafting is required at broad level
- When complexity demands broad approach to automation crafting
- When standard methods fail and broad is needed

## How to Apply
1. **Assess**: Evaluate the situation for automation crafting requirements
2. **Prepare**: Gather resources and knowledge for broad automation crafting
3. **Execute**: Apply broad techniques for automation crafting
...
- Seek feedback on broad automation crafting approach
...
---
Skill ID: the-hand-automation-crafting-broad
Branch: the-hand
