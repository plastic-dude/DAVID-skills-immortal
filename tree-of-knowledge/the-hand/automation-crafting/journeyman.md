# Automation Crafting — Journeyman
...
## When to Use
- When automation crafting is required at journeyman level
- When complexity demands journeyman approach to automation crafting
- When standard methods fail and journeyman is needed

## How to Apply
1. **Assess**: Evaluate the situation for automation crafting requirements
2. **Prepare**: Gather resources and knowledge for journeyman automation crafting
3. **Execute**: Apply journeyman techniques for automation crafting
...
- Seek feedback on journeyman automation crafting approach
...
- Automation Crafting — Master — alternate variation
...
---
Skill ID: the-hand-automation-crafting-journeyman
Branch: the-hand
