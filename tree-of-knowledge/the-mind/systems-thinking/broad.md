...
## When to Use
- When systems thinking is required at broad level
- When complexity demands broad approach to systems thinking
- When standard methods fail and broad is needed

## How to Apply
1. **Assess**: Evaluate the situation for systems thinking requirements
2. **Prepare**: Gather resources and knowledge for broad systems thinking
3. **Execute**: Apply broad techniques for systems thinking
...
- Seek feedback on broad systems thinking approach
...
- Systems Thinking — Journeyman — alternate variation
...
---
Skill ID: the-mind-systems-thinking-broad
Branch: the-mind
