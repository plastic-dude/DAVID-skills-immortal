...
## When to Use
- When recursive reasoning is required at broad level
- When complexity demands broad approach to recursive reasoning
- When standard methods fail and broad is needed

## How to Apply
1. **Assess**: Evaluate the situation for recursive reasoning requirements
2. **Prepare**: Gather resources and knowledge for broad recursive reasoning
3. **Execute**: Apply broad techniques for recursive reasoning
...
- Seek feedback on broad recursive reasoning approach
...
---
Skill ID: the-mind-recursive-reasoning-broad
Branch: the-mind
