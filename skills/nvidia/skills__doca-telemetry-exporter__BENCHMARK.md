...
Evaluation of the `doca-telemetry-exporter` skill before publication through Skill Evaluator.
...
- LOW SCHEMA/unexpected_file: Unexpected 'SKILLCARD.yaml' in skill root (`skills/libs/doca-telemetry-exporter/SKILLCARD.yaml`)
